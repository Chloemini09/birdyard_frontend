...
import BirdPlantPreferenceChart from 'src/components/BirdPlantPreferenceChart.vue'
import MonthlyBirdActivityChart from 'src/components//MonthlyBirdActivityChart.vue'
import PlantRegionSuitabilityMap from 'src/components//PlantRegionSuitabilityMap.vue'
import PlantRequirementsChart from 'src/components/PlantRequirementsChart.vue'
