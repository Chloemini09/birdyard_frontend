  ...
  <div class="plant-advice-container">
    ...
    <div class="content-section">
      ...
      <div class="recommendations-section" v-if="selectedSeason">
        ...
        <h3>Click the 🔍 button to see more info of your plants</h3>
...
.plant-info p {
  color: #555;
  line-height: 1.6;
  flex-grow: 1; /* This allows the p to take up space, so button can be positioned relative to it if needed */
  margin-bottom: 0; /* Removed bottom margin from p if button is at top */
}
