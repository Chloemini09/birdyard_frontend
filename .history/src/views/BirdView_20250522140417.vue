    ...
    <section class="hero-section">
      ...
      <div class="hero-content">
        ...
        <p class="hero-subtitle">
          Transform your garden into a conservation sanctuary. Our advanced AI identifies endangered
          species and provides personalized recommendations to protect local wildlife.
        </p>
        ...
        <div class="upload-section">
          <p class="upload-instruction">
            📸 Upload a clear photo of any bird for instant identification
          </p>
    ...
    <section class="endangered-birds-section-enhanced">
      <div class="section-container-enhanced">
        <div class="section-header-enhanced">
          <div class="section-badge"><span>🔴</span> Conservation Alert</div>
