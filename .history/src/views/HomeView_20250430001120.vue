  ...
  <div class="home-page">
    ...
    <section class="info-section">
      <div class="container">
        ...
        <!-- Plant Information Card - Modified to link directly -->
          ...
          <div class="info-card">
            <router-link to="/plantadvice" class="card-image">
              ...
              <div class="card-overlay">
                ...
                <span class="find-plants-btn">Let's find your plants now</span>
              </div>
            </router-link>
          </div>
        </div>

        <!-- Birds Information Card - Modified to link directly -->
