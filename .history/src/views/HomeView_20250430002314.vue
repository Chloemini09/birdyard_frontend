<template>
  <div class="home-page">
    ...
    <!-- Information Section (Modified - Now with direct links instead of popups) -->
    <section class="info-section">
      <div class="container">
        ...
        <!-- Plant Information Card - Enhanced with visible description and large hover button -->
        ...
        <!-- Birds Information Card - Enhanced with visible description and large hover button -->
...
/* Info Section Styles - REDESIGNED GRID LAYOUT */
.info-section {
  padding: 60px 0;
...
.card-image {
  ...
  cursor: pointer;
  overflow: hidden;
  display: block; /* Make the router-link take full height */
}
