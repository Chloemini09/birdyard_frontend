  ...
  <div class="home-page">
    ...
    <section class="info-section">
      <div class="container">
        ...
        <!-- Plant Information Card - Enhanced hover and click effects -->
        ...
        <!-- Birds Information Card - Enhanced hover and click effects -->
          ...
          <div class="info-card">
            <router-link to="/plantadvice" class="card-image">
              ...
              <div class="card-overlay">
                ...
                <span class="find-plants-btn">找到适合你的植物 →</span>
              </div>
              <div class="hover-overlay"></div>
            </router-link>
          </div>
...
.card-image:hover .card-overlay {
  background: linear-gradient(transparent 30%, rgba(10, 50, 0, 0.9));
  transform: translateY(-10px);
}

.card-image:hover .overlay-description,
