...
import BirdPlantPreferenceChart from './BirdPlantPreferenceChart.vue'
import MonthlyBirdActivityChart from './MonthlyBirdActivityChart.vue'
import PlantRegionSuitabilityMap from './PlantRegionSuitabilityMap.vue'
import PlantRequirementsChart from './PlantRequirementsChart.vue'
