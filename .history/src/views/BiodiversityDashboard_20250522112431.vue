  ...
  <div class="biodiversity-dashboard">
    <section class="contact-banner">
      <div class="banner-overlay">
        ...
        <p class="contact-subtitle">Live Bird Migration Tracking & Data Insights</p>
        <p class="contact-subtitle">Follow the Flight Path - Real-Time Bird Migration Data</p>
      </div>
    </section>
    ...
    <div class="map">
      <div class="map-section-header">
        ...
        <p class="map-section-instructions">
          Explore native bird habitats across Australia. Click on regions to see detailed
          information about local species and plant preferences. We will show you bird's route with
          Australia!
        </p>
      </div>
    ...
    <div v-else class="analysis-section">
      <h2 class="analysis-section-header">Biodiversity Analysis</h2>
      <p class="analysis-section-instructions">
