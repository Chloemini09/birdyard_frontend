...
export default {
  ...
  data() {
    return {
      ...
      // Sample species info - in a real app, this could come from an API or data file
      speciesData: {
        'Australian Magpie': {
          description: 'The Australian Magpie is a medium-sized black and white passerine bird native to Australia and southern New Guinea. It's known for its melodic warbling call and territorial behavior during breeding season.'
        },
        'Sulphur-Crested Cockatoo': {
          description: 'The Sulphur-crested Cockatoo is a large white cockatoo with a distinctive yellow crest. It's known for its loud calls and is commonly found in wooded habitats across Australia.'
        },
        'Rainbow Lorikeet': {
          description: 'The Rainbow Lorikeet is a species of parrot found in Australia. With its vibrant coloration including blue, green, yellow and orange feathers, it's one of the country's most iconic birds.'
        },
        'Eastern Rosella': {
          description: 'The Eastern Rosella is a colorful parrot native to southeast Australia. Its distinctive plumage includes a red head, white cheeks, and yellow-to-green body.'
        },
        'Superb Fairywren': {
          description: 'The Superb Fairywren is a small Australian bird known for the male's bright blue and black plumage during breeding season. They're highly social birds that live in small groups.'
        }
      }
    };
  },
